...
return [
    ...
    */
    ...
    'digits_between' => 'يجب أن يكون وعيد أرقام :attribute بين :min و :max.',
    ...
    'min' => [
        'numeric' => 'يجب أن يكون :attribute مساويًا لـ :min على الأقل.',
        'file' => 'يجب أن يكون حجم :attribute مساويًا لـ :min كيلوبايت على الأقل.',
        'string' => 'يجب أن يكون عدد أحرف :attribute مساويًا لـ :min على الأقل.',
    ...
    */
    ...
    'attributes' => [
        ...
        // 'image' => 'الصورة', // 'image' rule handles it but attribute name is also good
    ],
